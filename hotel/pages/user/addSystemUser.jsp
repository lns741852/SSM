	...
	<div class="formbody">
		...
		<div id="usual1" class="usual">
			<div id="tab1" class="tabson">
				<ul class="forminfo">
					<li style="margin-top: 20px;"><label for="name">帳號<b>*</b></label>
						<div class="vocation">
					...
					<br />
					<br />
					<li><label for="price" style="cursor: pointer">密碼<b>*</b></label>
						<div class="vocation">
					...
					<br />
					<li>
					<label for="yajin" style="cursor: pointer">權限<b>*</b></label>
						<div class="vocation">
